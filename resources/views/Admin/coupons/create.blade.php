                                ...
                                <form action="{{ route('admin.coupons.store') }}" method="POST">
                                    ...
                                    <div class="card-body" id="couponForms">
                                        <div class="form-group coupon-form">
                                            ...
                                            <textarea name="description[]" class="form-control">{{ old('description.0') }}</textarea>
                                            @error('description.0')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="popular_coupons[]"
                                                    class="custom-control-input popular-checkbox" id="popularCoupon_0"
                                                    value="1">
                                                <label class="custom-control-label"
                                                    for="popularCoupon_0">Popular</label>
                                            </div>

                                            <button type="button" class="btn btn-success add-coupon-btn">+</button>
                                            <button type="button" class="btn btn-danger remove-coupon-btn">-</button>
                                        </div>
                                    </div>
