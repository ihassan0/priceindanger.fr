...
<body>
    ...
    <!-- Breadcrums start -->
    @include('components.breadcrums', ['current_page' => "Offres"])
    <!-- Breadcrums end -->
                    ...
                    <div class="mb-5">
                        ...
                        <ul class="flex flex-col gap-2 mt-4">
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                <label for="category-{{ $key }}" class="cursor-pointer whitespace-nowrap text-ellipsis overflow-hidden">{{ $topcat->name }}</label>
                            </li>
                            @endforeach
                        </ul>
                    </div>
