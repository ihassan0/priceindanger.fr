...
<body>
    ...
    <section class="container my-10">
        <div class="lg:flex gap-5">
            <aside class="lg:w-[30%] relative border-r pr-2">
                    ...
                    <form>
                        <div class="flex gap-4">
                            <input type="text" name="name" placeholder="Ton Nom"
                                class="border border-gray-300 p-3 rounded-sm flex-1">
                            <input type="email" name="name" placeholder="Votre email"
                                class="border border-gray-300 p-3 rounded-sm flex-1">
                        </div>
                        <textarea name="message" cols="30" placeholder="Votre commentaire"
                            class="border border-gray-300 p-3 rounded-sm w-full mt-4"></textarea>
